var gulp = require('gulp'),
  ...
  const babel = require('gulp-babel');//Подклюаем  babel
...
gulp.task('watch', ['browser-sync', 'scss', 'css', 'html', 'ES6', 'js', 'img', 'fonts', 'scripts'], function() {
  ...
  gulp.watch('app/js/script.js', ['ES6']);
